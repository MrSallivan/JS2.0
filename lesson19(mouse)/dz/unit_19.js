...
function t5() {
	let valClass = document.querySelector('.div-5').classList
	valClass.toggle('active')
}
...
function t6() {
	let valClass = document.querySelector('.ul-6').classList
	valClass.toggle('hide')
}
...
function t7() {
	let valClass = document.querySelector('.div-7').classList
	valClass.toggle('active')
}
...
function t8() {
	let check = document.querySelector('.ch-8').checked
	if (check == true) {
...
function t15() {
	...
	document.querySelector('.div-15.block').innerHTML = a
