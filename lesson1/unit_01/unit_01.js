...
console.log('Дрбро ' + 'пожоловать ' + 'на курс');
...
document.querySelector('div.three').innerHTML = '<h3>Заголовок третьего уровня</h3>'
...
// document.querySelector('.four').innerHTML = '<h4>Заголовок четвёртого уровня</h4>'
// document.querySelector('.four').innerHTML += '<p><i>Произвольный текст</i></p>'

document.querySelector('.four').innerHTML = `<h4>Заголовок четвёртого уровня</h4><p><i>Произвольный текст</i></p>`
