...
function t3() {
	fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&name=Alex&num1=10&num2=150')
		.then(response => response.text())
		.then(response => {
			out('.out-3', response)
		})
...
function t4() {
	fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&name=Alex&num1=10&num2=150')
		.then(response => response.text())
		.then(response => {
			out('.out-4', response)
		})
...
function t5() {
	fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=5&name=Alex&num1=10&num2=150')
		.then(response => response.text())
		.then(response => {
			out('.out-5', response)
		})
...
function t6() {
	fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&name=Alex&num1=10&num2=150')
		.then(response => response.text())
		.then(response => {
			out('.out-6', response)
		})
...
function t7() {
	fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=7&name=Alex&num1=10&num2=150')
		.then(response => response.text())
		.then(response => {
			out('.out-7', response)
		})
...
function t8() {
	fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&name=Alex&num1=10&num2=150&year=1984')
		.then(response => response.text())
		.then(response => {
			out('.out-8', response)
		})
...
function t9() {
	fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=9&name=Alex&num1=10&num2=150&year=1984&m=1&d=1&y=1')
		.then(response => response.text())
		.then(response => {
			out('.out-9', response)
		})
