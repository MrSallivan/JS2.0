...
function f6() {
	let keySet = document.querySelector('.i-61').value
	let valSet = document.querySelector('.i-62').value
	a6[keySet] = valSet
	f5(a6, '.out-6')
}
...
function f7() {
	...
	let keySet = document.querySelector('.i-7').value
	for (let key in a7) {
		if (a7[keySet] !== undefined) {
...
function f18() {
    let st = document.querySelector('.i-18').value
    let out = ''
    for(let key in a18) {
        if (key == st) {
            out = a18[key].join(' ')
