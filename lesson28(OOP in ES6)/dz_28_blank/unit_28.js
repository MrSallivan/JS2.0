...
let image = ['https://htstatic.imgsmail.ru/pic_image/0ae9e4124e3c9210bbdbe257e425c508/450/450/1278214/', 'https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/iphone-11-pro-select-2019-family_GEO_EMEA?wid=882&amp;hei=1058&amp;fmt=jpeg&amp;qlt=80&amp;op_usm=0.5,0.5&amp;.v=1567812929188']

let goods = new Goods('Iphone', 500, image, 25000)
console.log(goods)
...
let goods2 = new Goods('Iphone', 500, image[0], 25000)
goods2.draw('.out-4')
...
let myValid2 = new Valid('nav@mail.ru', '1sd344g')
myValid2.validate()
console.log(myValid2.isValid)
...
let valid2 = new Valid2('', 'sjoutyug')
valid2.validate()
console.log(valid2)
 ...
 let valid3 = new Valid2('mail@mail.ru', 'password12345')
 valid3.validate()
 console.log(valid3)
