...
function t3(event) {
	if (event.target.className == 'div-3_1 block') {
		document.querySelector('.out-3').innerHTML += document.querySelector('.div-3_1').textContent
	}
	if (event.target.className == 'div-3_2 block') {
		document.querySelector('.out-3').innerHTML += document.querySelector('.div-3_2').textContent
	}
}
...
function t4() {
	...
	// 	document.querySelector('.out-4').textContent += 'touch'      -- еще один вариант
	// }
	document.querySelector('.div-4').addEventListener('touchstart', tch)
}
...
function t5() {
	// document.querySelector('.div-4').ontouchstart = null  --- снятие события от ontouchstart
	document.querySelector('.div-4').removeEventListener('touchstart', tch)
}
