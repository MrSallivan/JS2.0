...
function f8() {
	...
	document.querySelector('.out-8-1').innerHTML = `длинна массива равна: ${ar8.length}`
}
...
function f14() {
	let out = ''
	for (let i = ar14.length - 1; (i < ar14.length) && (i >= 0); i--) {
		out += ar14[i] + ' '
	}
